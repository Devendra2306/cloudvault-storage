 ...
 * @access  Private
 */
router.post('/upload', authenticate, checkQuota, upload.single('file'), fileController.uploadFile);
 ...
 * @access  Private
 */
router.get('/:id/download', authenticate, fileController.getDownloadUrl);
